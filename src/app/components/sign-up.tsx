...
import { initFirebase, signInWithGooglePopup, signUpEmailPassword, isFirebaseConfigured } from "../../lib/firebaseClient";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isFirebaseConfigured()) {
        const { idToken } = await signUpEmailPassword(name, email, password);
        const res = await fetch("/api/auth/firebase-login", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ idToken, password, isSignup: true }),
        });
    ...
    <div className="login-container">
      ...
      >
        ...
        <div className="temp">
                ...
                <Link href="/login" className="toggle-button">
                    Login
                </Link>
        </div>
